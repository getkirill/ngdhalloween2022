...
let PUBLIC = import_electron.app.isPackaged ? process.env.DIST : (0, import_path.join)(process.env.DIST_ELECTRON, "../public");
...
async function createWindow() {
  win = new import_electron.BrowserWindow({
    title: "Main window",
    icon: (0, import_path.join)(PUBLIC, "favicon.svg"),
    width: 1280,
    height: 720,
    webPreferences: {
